...
class start_up_node():
    def __init__(self):
        ...
        # Publications
        self.state_pub = rospy.Publisher('/bin_bot_base/state', String, queue_size=10)
    ...
    def spin(self):
        ...
        if (self.serv_state.data == 'MAP_AT_SERVER' and (os.path.isfile('/home/sglvladi/map/map.yaml') and os.path.isfile('/home/sglvladi/map/map.pgm'))):
            rospy.loginfo('Map received. Waking up Bin Bot.... ')
            self.nodes_started = True
            rospy.sleep(rospy.Duration(5))
            subprocess.call('roslaunch bin_bot_base full_bin_bot_base.launch', shell = True)
